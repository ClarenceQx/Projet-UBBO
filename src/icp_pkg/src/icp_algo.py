...
def icp_algo(reference_points, points, max_iterations=100, distance_threshold=0.3, convergence_translation_threshold=1e-3,
    ...
    for iter_num in range(max_iterations):
        ...
        transformation_history[0] += closest_translation_x
        transformation_history[1] += closest_translation_y
        transformation_history[2] += closest_rot_angle
